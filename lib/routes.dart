...
import 'package:flowkit/view/apps/project/create_project_screen.dart';
import 'package:flowkit/view/apps/project/project_detail_screen.dart';
import 'package:flowkit/view/apps/project/project_list_screen.dart';
...
import 'package:flowkit/view/dashboard/hospital_screen.dart';
...
List<GetPage> getPageRoute() {
  var routes = [
    ...
    GetPage(
        ...
        middlewares: [AuthMiddleware()]),
    GetPage(
        name: '/app/project/project_list',
        page: () => ProjectListScreen(),
        middlewares: [AuthMiddleware()]),
    GetPage(
        name: '/app/project/project_detail',
        page: () => ProjectDetailScreen(),
        middlewares: [AuthMiddleware()]),
    GetPage(
        name: '/app/project/create_project',
