...
import 'package:flowkit/helpers/widgets/my.dart';
import 'package:flowkit/helpers/widgets/my_breadcrumb_item.dart';
import 'package:flowkit/helpers/widgets/my_constant.dart';
import 'package:flowkit/helpers/widgets/my_screen_media.dart';
...
class AppTheme {
  ...
  static Color primaryColor = Color(0xff006a64);
  ...
  static void initMyStyle() {
    ...
    My.setConstant(MyConstantData(
      ...
      defaultBreadCrumbItem:
          MyBreadcrumbItem(name: 'FlowKit', route: '/client/home'),
    ));
    bool isMobile = true;
    try {
