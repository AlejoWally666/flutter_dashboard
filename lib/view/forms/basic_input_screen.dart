...
import 'package:flowkit/controller/forms/basic_input_controller.dart';
          ...
          return Column(
            children: [
              ...
              Padding(
                ...
                child: MyFlex(
                  children: [
                    MyFlexItem(sizes: 'lg-3', child: radioButton()),
                    MyFlexItem(sizes: 'lg-3', child: selectDate()),
                    MyFlexItem(sizes: 'lg-3', child: selectTime()),
                    MyFlexItem(sizes: 'lg-3', child: selectRange()),
                    MyFlexItem(sizes: 'lg-3', child: selectDateTime()),
            ...
            child: Column(
              ...
              children: [
                        ...
                        child: MyContainer.bordered(
                          ...
                          child: Row(
                            children: <Widget>[
                              MyText.labelMedium(
                                controller
                                    .floatingLabelBehavior.name.capitalize!,
                                color: theme.colorScheme.onSurface,
                              ),
                              Container(
                ...
                Row(
                  children: [
                    SizedBox(
                        width: 180, child: MyText.labelLarge("Border Type")),
                    PopupMenuButton(
                        clipBehavior: Clip.antiAliasWithSaveLayer,
                        shape: OutlineInputBorder(
                            borderSide: BorderSide.none,
                    ...
                    Column(
                      children: [
                        Row(
                          children: [
                            SizedBox(
                                width: 100, child: MyText.labelLarge("filled")),
                            Switch(
                    ...
                    Column(
                      children: [
                        ...
                        Row(
                          children: [
                            SizedBox(
                                width: 100, child: MyText.labelLarge("Pilled")),
                            Switch(
