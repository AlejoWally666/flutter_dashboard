import 'package:flowkit/controller/extra_pages/time_line_controller.dart';
                      ...
                      child: Timeline.tileBuilder(
                        ...
                        builder: TimelineTileBuilder.fromStyle(
                          ...
                          contentsBuilder: (context, index) {
                            ContactLeadModal time = controller.timeline[index];
                            return MyCard(
                              width: 400,
                              borderRadiusAll: 8,
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  MyContainer(
                                    ...
                                    clipBehavior: Clip.antiAliasWithSaveLayer,
                                    child: Image.asset(Images.landscape[index % Images.landscape.length], fit: BoxFit.cover),
                                  ),
                                  MySpacing.height(12),
                                  MyText.bodyMedium(
                                  ...
                                  MySpacing.height(12),
                                  MyText.bodySmall("Location : ${time.location}", fontWeight: 600),
                                  MySpacing.height(12),
                                  MyText.bodyMedium(
