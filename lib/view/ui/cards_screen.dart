import 'package:flowkit/controller/ui/cards_controller.dart';
              ...
              Padding(
                ...
                child: MyFlex(
                  children: [
                    ...
                    MyFlexItem(
                        sizes: 'xl-2 lg-4 md-6 sm-12',
                        child: stateCart(LucideIcons.user, contentTheme.success,
                            "Total Visitors", "365238", "Increased by +1.34")),
                    MyFlexItem(
                        sizes: 'xl-2 lg-4 md-6 sm-12',
                        child: stateCart(
                    ...
                    MyFlexItem(
                        ...
                        child: stateCart(
                            ...
                            "Increased by +1.34")),
                    MyFlexItem(
                        sizes: 'lg-4 md-6', child: buildTrafficSources()),
    ...
    return MyCard(
      ...
      child: SizedBox(
        ...
        child: Column(
          ...
          children: [
            Padding(
              padding: MySpacing.only(left: 23, top: 23),
      ...
      child: Column(
        ...
        children: [
          MyContainer(
            ...
            paddingAll: 0,
            clipBehavior: Clip.antiAliasWithSaveLayer,
            child: Image.asset(Images.nft[2], fit: BoxFit.cover),
          ),
          MyText.bodyMedium(controller.dummyTexts[4], maxLines: 2),
          MyText.bodyMedium(controller.dummyTexts[5], maxLines: 3),
        ],
      ),
    );
  }
      ...
      child: Column(
        ...
        children: [
          ...
          MyContainer(
            ...
            width: double.infinity,
            clipBehavior: Clip.antiAliasWithSaveLayer,
            child: Image.asset(Images.nft[1], fit: BoxFit.cover),
          ),
          ...
          MyButton.block(
              ...
              elevation: 0,
              backgroundColor: contentTheme.primary,
              child: MyText.bodyMedium("Another Link",
      ...
      child: Column(
        ...
        children: [
          MyContainer(
            ...
            height: 300,
            width: double.infinity,
            child: Image.asset(Images.nft[0], fit: BoxFit.cover),
          ),
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                MyButton(
                    ...
                    child: MyText.bodyMedium("Click Link",
                        fontWeight: 600, color: contentTheme.onPrimary))
              ],
            ),
          ),
