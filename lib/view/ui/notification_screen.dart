import 'package:flowkit/controller/ui/notification_controller.dart';
                          ...
                          children: [
                            Padding(
                              padding: MySpacing.only(
                                  left: 23, top: 20, bottom: 8, right: 23),
                            ...
                            Padding(
                              padding: MySpacing.only(
                                  left: 23, top: 8, bottom: 23, right: 23),
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Wrap(
      ...
      child: Column(
        ...
        children: [
          ...
          DropdownButtonFormField<SnackBarBehavior>(
            ...
            items:
                SnackBarBehavior.values.map<DropdownMenuItem<SnackBarBehavior>>(
